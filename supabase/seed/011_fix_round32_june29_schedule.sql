-- Corrige el orden real de los primeros 16avos.
-- Brasil-Japon se juega antes que Alemania-Paraguay.
-- Costa de Marfil-Noruega se juega antes que Francia-Suecia.

with fixture(fifa_match_no, kickoff_at, venue, home_slot, away_slot, home_code, away_code) as (
  values
    (74, '2026-06-29 17:00:00+00'::timestamptz, 'NRG Stadium, Houston', '1C', '2F', 'BRA', 'JPN'),
    (75, '2026-06-29 20:30:00+00'::timestamptz, 'Gillette Stadium, Foxborough', '1E', '3ABCDF', 'GER', 'PAR'),
    (76, '2026-06-30 01:00:00+00'::timestamptz, 'Estadio BBVA, Guadalupe', '1F', '2C', 'NED', 'MAR'),

...
7. Ejecuta `supabase/seed/009_fix_knockout_slots.sql`, `supabase/seed/010_set_real_round32_bracket.sql`, `supabase/seed/011_fix_round32_june29_schedule.sql`, `supabase/seed/013_repair_knockout_bracket_and_data.sql`, `supabase/seed/014_fix_round32_july1_times.sql` y `supabase/seed/015_fix_round32_july3_times.sql`.
